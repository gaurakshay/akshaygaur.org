...
&lt;/html&gt;</code></pre>
            ...
            Please note lines:
            <ul>
              <li><em>6-8:</em> We define a block in the this parent template named base.html
            which will contain the title of the page.</li>
              <li><em>38-40:</em> We define a block of content that will sit in our body tag 
              of our html.
            </ul>
...
{% endblock content %}</code></pre>
            ...
            <p>When you are done with making all the changes, you will find that
