...
&lt;/html&gt;</code></pre> Now, that we have our basic webpage, we would like our application to serve it. The way a django application works
          ...
          </p> <p> To define a view, we must go to our students/views.py file. In this file, we will define our most basic view:
...
class WelcomeView(TemplateView):
    ...
    template_name = 'welcome.html'</code></pre>
          </p> <p> As we will be serving web pages primarily, we want to define the urls that we will be serving our pages in. In
...
urlpatterns = [
    path('admin/', admin.site.urls),
          ...
          </p> <p> Lets see what we need to do to change that. Let us define a new urlpattern that points to the root path:
          <pre><code class="language-python">from django.contrib import admin
from django.urls import path, include
...
urlpatterns = [
    ...
    path('', views.WelcomeView.as_view(), name='welcome'),
          ...
          </p> <p> Now, making sure that our server is running, cross your fingers go to 127.0.0.1:8000/ in your favourite browser.
