    ...
    def __str__(self):
        ...
        return "{0} {1}".format(self.s_first_name, self.s_last_name)</code></pre>
          <p>
            ...
            </p> <p> We also need to define where "student_pics" folder will reside. This is defined with the help of MEDIA_URL and
            ...
            </p> <p> To define this, go to the end of your settings.py file and add the following:
          </p>
...
admin.site.register(Student)</code></pre>
          <p> Your admin site should now look like this:
            ...
            </p> <p> I went ahead and added an entry each for course and student:
            </p> <p>
            ...
            </p> <p> So now that we have saved our student with its pic, where is it? If you remember, we defined the MEDIA_URL as
            ...
            </p> <p> My folder structure looks like this after creating a student with a pic:
            <pre><code class="language-treeview">tutorial//
|-- assets//
|   `-- media//
|       `-- student_pics//
