...
urlpatterns = [
    ...
    path('', include('students.urls')),
          ...
          <p> Now, lets create a urls.py file in our students app. This file should be located at students/urls.py.</p>
...
urlpatterns = [
    path('', views.WelcomeView.as_view(), name='welcome'),
          ...
          <p> Now try going to 127.0.0.1:8000 again. If we did it right, you should see the same results!
          </p> <p>
          ...
          open up the views.py file in students directory. And add the following lines:</p>
...
class DeptListView(ListView):
    ...
    context_object_name = 'depts'</code></pre>
          <p> You must have noticed that the webpage that we defined for this page doesn't exist ('dept-list.html'). So lets
          fix this by make a html file named 'dept-list.html' in the --- you guessed right --- the templates folder.
          </p> <p> Create a skeleton like we did before and put the following: </p>
...
&lt;/body&gt;
&lt;/html&gt;</code></pre>
          <p> So at this point, what we have is a view named DeptListView that knows that it would render dept-list.html. The
...
urlpatterns = [
    ...
    path('depts/', views.DeptListView.as_view(), name='dept_list'),  # Add this...
          ...
          <p> Now, try going to the url 127.0.0.1:8000/depts/ and confirm that you see all the departments that you entered
          in the admin module show up here. Since I added only one, I only see one:
          </p> <p>
          <img src="../img/django-14-dept-list.png" alt="List of the departments in the system">
          </p> <p>
