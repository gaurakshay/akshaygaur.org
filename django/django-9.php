...
<p><?php include './django-boilerplate-top.php';?>
...
class StudentAddView(CreateView):
    ...
    form_class = StudentForm</code></pre>
          ...
          </p> <p> Create a file named 'stud-edit.html' in students/templates folder. Once created, add the following to the file:
...
&lt;/body&gt;
&lt;/html&gt;</code></pre>
          </p> <p> Now that we fixed that, let us enter some data in the form and try submitting again. Does the form submit the
          data correctly?
         ...
         redirect url" width="500">
          ...
          </p> <p> This is fixed in multiple ways:
          <ol type="a">
            <li> Defining the success url in our view.
              </p> <p> In our views.py, add the following to our existing code:
...
class StudentAddView(CreateView):
    ...
    success_url = reverse_lazy('stud_list')</code></pre>
              </p> <p> If you remember in our urls.py file, we defined the /students/ url with a name='stud_list', we pass this to
         ...
         to student list" width="500">
            ...
            <li> Defining the get_absolute_url in our model. If we don't add the success_url in our view, Django by default tries
              ...
              </p> <p> So, we will define the get_absolute_url for our student model in students/models.py file.
...
class Student(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse_lazy('stud_details', kwargs={'pk': self.pk})</code></pre>
              </p> <p> Now, assuming that success_url is not defined, when you again enter a student's details in the form and submit,
              you will see:
              </p> <p>
         ...
         student details" width="500">
          ...
          </p> <p> Here we can implement some basic validation in the template of ours like so:
          <pre><code class="language-django">&lt;!doctype html&gt;
&lt;html lang="en"&gt;
&lt;head&gt;
  &lt;meta charset="UTF-8"&gt;
...
&lt;/body&gt;
&lt;/html&gt;</code></pre>
          </p> <p> Now try and see the details of any student that doesn't have a picture:
          </p> <p>
