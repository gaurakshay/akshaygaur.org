...
?>
    ...
    <p>
            ...
            </p> <p> At this point, since we don't have an admin account setup in the project, we will create one. To do that, just
          ...
          <p> You will be asked to provide the password for this admin account which will create the admin account.
            </p> <p> Once you are done making the account, use the username and password to login to the admin interface we visited
            earlier.
            </p> <p>
            ...
            </p> <p> Here you can see what things you can do. We can see that we can add groups and users in this interface. BUT
            WAIT!!! Where is our model that we added earlier? Where are my departments???
            </p> <p> To be able to see our models in this interface, we need to register them in the project.
            </p> <p> To add our "Department" model so that we can access it in the admin model, we need to go to students/admin.py
...
admin.site.register(Department)</code></pre>
          <p> And that's it! Now, if you go back to the admin screen, you should see you model!
            ...
            </p> <p> If you click on the add link, you will be taken to "Add Department" screen:
            </p> <p>
            <img src="../img/django-6-add-dept.png" width="400" alt="Admin Screen with Departments">
            </p> <p> Here, you can see that django automatically guesses the field names from the model entries that we made earlier
...
d_chair = models.CharField(max_length=200, verbose_name="Department Chair")</code></pre>
          <p>
            ...
            </p> <p> Let us add a department as a model. Enter name, code and chair as you see fit. I added them and then clicked
            on the save button provided.
            </p> <p> **NOTE** In the screenshot, the department is listed as "Department object (CS)" which is wrong. It should have
            ...
            </p> <p> If you click on the department object you can see its details. You can aldo edit the object's details if you
            want to.
            </p> <p>
