...
class StudentListView(ListView):
    ...
    context_object_name = 'students'</code></pre>
          </p> <p> And, create the template named 'stud-list.html' in the templates folder:
...
&lt;/body&gt;
&lt;/html&gt;</code></pre>
          </p> <p> Add the url in student/urls.py file like so:
...
urlpatterns = [
    ...
    path('students/', views.StudentListView.as_view(), name='stud_list'),
          ...
          </p> <p> If we go to the url 127.0.0.1:8000/students/ we should see the following:
          </p> <p>
    ...
    context_object_name = 'student'</code></pre>
          </p> <p> Now, add the stud-details.html in the templates folder and type in it the following basic html:
          </p> <p>
          <pre><code class="language-django ">&lt;!doctype html&gt;
&lt;html lang="en "&gt;
&lt;head&gt;
...
&lt;/body&gt;
&lt;/html&gt;</code></pre>
          </p> <p> Notice how we used the student object's picture attribute to define the source of the image in an &lt;img&gt;
          tag.
...
urlpatterns = [
    ...
    path('students/&lt;int:pk&gt;/details/', views.StudentDetailView.as_view(), name='stud_details'),
          ...
          </p> <p> Now, coming back to the templates/stud-list.html, we can finally add to it the link to details of the student:
          </p> <p>
          <pre><code class="language-django ">&lt;!doctype html&gt;
&lt;html lang="en "&gt;
&lt;head&gt;
...
&lt;/body&gt;
&lt;/html&gt;</code></pre>
          </p> <p> If you go to 127.0.0.0:8000/students/ again, you should see the page displayed with the link to see the details
          of the student:
          </p> <p>
          ...
          </p> <p> in students/template/stud-details.html and try to reload the page:
          </p> <p>
          <img src="../img/django-20-stud-details.png " alt="Student details " width="300 ">
...
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)</code></pre>
          </p> <p> Now try to load student details page again:
          </p> <p>
