...
<div class="container">
        ...
        a login screen:<br>
        <img src="assets/django-2-admin-login.png" width="1000px"
        alt="Admin Login Screen"><br>
        ...
        <img src="assets/django-3-admin-cred.png" width="300px"
        alt="Entering Credentials"><br>
        <img src="assets/django-4-admin-screen.png" width="1000px"
        alt="Admin Screen"><br>
        ...
        see you model!<br>
        <img src="assets/django-5-admin-departments.png" width="400px"
        alt="Admin Screen with Departments"><br>
        If you click on the add link, you will be taken to "Add Department"
        screen:<br>
        <img src="assets/django-6-add-dept.png" width="400px"
        alt="Admin Screen with Departments"><br>
        ...
        <img src="assets/django-7-dept-name.png" width="400px"
        alt="Fixed Department Names"><br>
        ...
        **NOTE** In the screenshot, the department is listed as "Department object (CS)" which is wrong. It should have said "Computer Science"
        ...
        <img src="assets/django-8-dept-obj.png" width="400px"
        alt="Successful department entry"><br>
        If you click on the department object you can see its details. You can aldo
        edit the object's details if you want to.<br>
        <img src="assets/django-9-dept-details.png" width="400px"
        alt="Department's details."><br>
...
2        &emsp;&emsp;&emsp;&emsp;"""<br>
3        &emsp;&emsp;&emsp;&emsp;This model will store the details about courses present in the system.<br>
...
45        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;return "{0} {1}".format(self.s_first_name, self.s_last_name)<br>
        ...
        <img src="assets/django-10-admin-with-course-stud.png" width="500px"
        alt="Admin site with Department, Course and Student objects listed."><br>

        I went ahead and added an entry each for course and student:<br>
        <img src="assets/django-11-course-entry.png" width="500px"
        alt="Sample course entry."><br>
        <img src="assets/django-12-student-entry.png" width="500px"
        alt="Sample student entry."><br>
