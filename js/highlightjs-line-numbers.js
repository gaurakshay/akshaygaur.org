! function(n, e) {
    ...
    function t() {
        ...
        n.type = "text/css", n.innerHTML = h(".{0}{border-collapse:collapse}.{1}:before{content:attr({2})}", [f, m, j]), e.getElementsByTagName("head")[0].appendChild(n)
    }
    ...
    function l(t) {
        try {
            // Don't put line numbers in treeview.
            var r = e.querySelectorAll("code.hljs:not(.treeview)");
    ...
    function o(n, e) {
        ...
        if ("" === t[t.length - 1].trim() && t.pop(), t.length > e) {
            for (var r = "", l = 0, i = t.length; l < i; l++) r += h('<tr><td class="{0}"><div class="{1} {2}" {3}="{5}"></div></td><td class="{4}"><div class="{1}">{6}</div></td></tr>', [v, g, m, j, p, l + 1, t[l].length > 0 ? t[l] : " "]);
